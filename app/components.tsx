...
export function Header({dark=true}:{dark?:boolean}){
  return <header className={`site-header ${dark?"on-dark":"on-light"}`}>
    ...
    <nav aria-label="Navegação principal"><Link href="/ecossistema">Ecossistema</Link><Link href="/solucoes">Soluções</Link><Link href="/direcao">Direção</Link><Link href="/segmentos">Segmentos</Link><Link href="/ive">Método IVE</Link><Link href="/iara">IARA</Link></nav>
...
export function Footer(){return <footer className="global-footer">
  ...
  <div className="footer-links"><div><b>Descobrir</b><Link href="/ecossistema">Ecossistema</Link><Link href="/solucoes">Soluções</Link><Link href="/direcao">Alvos estratégicos</Link><Link href="/impacto">Impacto e legado</Link><Link href="/iara">IARA</Link><Link href="/insights">Insights</Link></div><div><b>Participar</b><Link href="/partnerships">Partnerships</Link><Link href="/talentos">Gente e cultura</Link><Link href="/capital">Capital</Link><Link href="/conectar">Conectar</Link><Link href="/portal">Portal IMTS</Link></div><div><b>Confiança</b><Link href="/governanca">Governança</Link><Link href="/governanca#privacidade">Privacidade</Link><Link href="/governanca#integridade">Integridade</Link><Link href="/governanca#acessibilidade">Acessibilidade</Link><Link href="/integracoes">Prontidão técnica</Link></div></div>
